...
public class SectionDaoTest extends TestConfiguration {
	...
	public void testSaveOrUpdateTask () {
		...
		Task taskTmp = (Task) this.sectionDao.getHibernateTemplate().load(Task.class, id) ;
	...
	public void testGetAllTasks () {
		...
		List <Section> sections = this.sectionDao.getAllSection() ;
	...
	public void testDeleteTask () {
		...
		Task taskTmp = (Task) this.sectionDao.getHibernateTemplate().get(Task.class, id) ;
		assertNull(taskTmp) ;
