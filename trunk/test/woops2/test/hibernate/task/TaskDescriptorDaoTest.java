...
public class TaskDescriptorDaoTest extends TestConfiguration {
	...
	protected void setUp () throws Exception {
		...
		this.taskDescriptorDao = (TaskDescriptorDao) super.getBeanFactory().getBean("TaskDescriptorDao") ;
	...
	protected void tearDown () throws Exception {
		...
		try {
			this.taskDescriptorDao.getHibernateTemplate().delete(this.taskDescriptor) ;
		}
	 ...
	 * 
	 * PRINCIPLE Create a tmp taskDescriptor, save it into the database with the method to test. Then look
	 * for the database to check if this tmp taskDescriptor exists. To finish delete this tmp taskDescriptor
	 * from the database.
	 */
	...
	/**
	 * Test method for {@link woops2.hibernate.task.TaskDescriptorDao#getAllTaskDescriptors()}.
	 * 
	 * PRINCIPLE Create a tmp taskDescriptor, save it into the database. Then get all activities from the
	 * database with the method to test, and look if the size of the activities set got is >= 1. To
	 * finish delete this tmp taskDescriptor from the database.
	 */
	public void testGetAllTaskDescriptors () {
		...
		// Look if this taskDescriptor is also into the database and look if the size of the set is >= 1.
	...
	/**
	 * Test method for {@link woops2.hibernate.task.TaskDescriptorDao#getTaskDescriptor()}.
	 * 
	 */
	...
	/**
	 * Test method for {@link woops2.hibernate.task.TaskDescriptorDao#deleteTaskDescriptor()}.
	 * 
	 */
	public void testDeleteTaskDescriptor () {
		...
		// Test the method deleteTaskDescriptor with an acitivity existing into the db.
		...
		// Test the method deleteTaskDescriptor with a taskDescriptor unexisting into the db.
