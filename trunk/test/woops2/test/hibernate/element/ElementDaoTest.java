...
public class ElementDaoTest extends TestConfiguration {
	...
	protected void setUp () throws Exception {
		...
		this.elementDao = (ElementDao) super.getBeanFactory().getBean("ElementDao") ;
	...
	/**
	 * Test method for {@link woops2.hibernate.element.ElementDao#getAllElements()}.
	 * 
	 */
	public void testgetAllElements () {
		...
		// Look if this element is also into the database and look if the size of the set is >= 1.
	...
	/**
	 * Test method for {@link woops2.hibernate.element.ElementDao#deleteElement()}.
	 * 
	 */
	public void testDeleteElement () {
		...
		Element elementTmp = (Element) this.elementDao.getHibernateTemplate().get(Element.class, id) ;
		assertNull(elementTmp) ;
