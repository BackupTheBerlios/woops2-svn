...
*/
	...
	var span = this.getDTPNode(dtpicker.getId());
...
function CalendarPainter_createCalendarTable(calData, table) {
	...
	var dtStartDay            = dtpicker.getStartDay();            // day the calender should start with
...
function CalendarPainter_getDTPNode(id) {
	return document.getElementById(DTP_PREFIX + id);
}
