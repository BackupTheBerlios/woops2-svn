                ...
                implements isimarket.servants.alarmservant.AlarmServant, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("getAlarmListFromWallet", new java.lang.Integer (4));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 4:  // isimarket/model/servants/alarmservant/AlarmServant/getAlarmListFromWallet
       {
         int walletId = in.read_long ();
         isimarket.model.Alarm $result[] = null;
         $result = this.getAlarmListFromWallet (walletId);
         out = $rh.createReply();
       ...
       case 6:  // isimarket/model/servants/alarmservant/AlarmServant/createAlarm
       {
         ...
         isimarket.model.Alarm $result = null;
         $result = this.createAlarm (name, walletId, alarmTypeId, actionTypeCode);
         out = $rh.createReply();
         isimarket.model.AlarmHelper.write (out, $result);
         break;
       }
