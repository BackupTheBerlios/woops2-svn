                ...
                implements isimarket.servants.walletservant.WalletServant, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("getActionsListFromWallet", new java.lang.Integer (1));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 1:  // isimarket/model/servants/walletservant/WalletServant/getActionsListFromWallet
       {
         int walletId = in.read_long ();
         isimarket.model.Action $result[] = null;
         $result = this.getActionsListFromWallet (walletId);
         out = $rh.createReply();
