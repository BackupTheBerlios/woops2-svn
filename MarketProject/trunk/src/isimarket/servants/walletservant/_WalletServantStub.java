...
public class _WalletServantStub extends org.omg.CORBA.portable.ObjectImpl implements isimarket.servants.walletservant.WalletServant
{
  ...
  public isimarket.model.Wallet getOperatorWallet (String login, String password)
  {
            ...
            try {
                ...
                return getOperatorWallet (login, password        );
            } finally {
                _releaseReply ($in);
            }
  } // getOperatorWallet

  public float getCash (int wallet_id)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getCash", true);
                $out.write_long (wallet_id);
                $in = _invoke ($out);
