...
public class _EventServantStub extends org.omg.CORBA.portable.ObjectImpl implements isimarket.servants.eventservant.EventServant
{
  ...
  public isimarket.model.Event[] getEventListFromActionType (String actionTypeCode)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getEventListFromActionType", true);
                $out.write_string (actionTypeCode);
                $in = _invoke ($out);
                ...
                return getEventListFromActionType (actionTypeCode        );
            } finally {
                _releaseReply ($in);
            }
  } // getEventListFromActionType
