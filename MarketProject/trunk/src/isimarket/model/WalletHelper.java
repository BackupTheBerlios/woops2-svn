...
abstract public class WalletHelper
{
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[1] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          _tcOf_members0 = isimarket.model.WalletActionHelper.type ();
          _tcOf_members0 = org.omg.CORBA.ORB.init ().create_sequence_tc (0, _tcOf_members0);
          _tcOf_members0 = org.omg.CORBA.ORB.init ().create_alias_tc (isimarket.model.WalletActionListHelper.id (), "WalletActionList", _tcOf_members0);
  ...
  public static isimarket.model.Wallet read (org.omg.CORBA.portable.InputStream istream)
  {
    ...
    value.actions = isimarket.model.WalletActionListHelper.read (istream);
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, isimarket.model.Wallet value)
  {
    ...
    isimarket.model.WalletActionListHelper.write (ostream, value.actions);
