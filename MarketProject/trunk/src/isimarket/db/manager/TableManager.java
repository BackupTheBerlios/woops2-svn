...
public class TableManager {
	...
	private static final String _CREATE_ACTION = "create table action(action_id integer, buy_price float, buy_date varchar(10),"
			+ " quantity integer, action_type_code varchar(2), wallet_id integer, primary key (action_id),"
	...
	// Alarm
	private static final String _CREATE_ALARM = "create table alarm(alarm_id integer, name varchar(32), alarm_type_id integer ,action_type_code varchar(2),"
